  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10 px-6 md:px-10 lg:px-20 xl:px-32 border-2">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {/* Institute Info */}
        <div>
          <h2 className="text-2xl font-bold mb-4 text-white">MJD Coaching Institute</h2>
          <p className="text-sm leading-relaxed">
            Empowering students to achieve academic excellence and success in every field.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mb-1">123, MG Road, Indore, MP - 452001</p>
          <p className="text-sm mb-1">Phone: +91 9599272754</p>
